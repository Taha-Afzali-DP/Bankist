...
const account1 = {
  ...
  movementsDates: [
    ...
    '2025-09-14T09:15:04.904Z',
    '2025-09-18T10:17:24.185Z',
    '2025-09-19T14:11:59.604Z',
    '2025-09-21T17:01:17.194Z',
    '2025-09-20T23:36:17.929Z',
    '2025-09-20T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
const formatMovmentDate = function (date) {
  ...
  if (daysPassed <= 7) return `${daysPassed} days ago`;
    ...
    return new Intl.DateTimeFormat(date).format(new Date());
  }
};
...
console.log(8 ** (1 / 3));
//? MAX
console.log(Math.max(55, 10, 1, 100, 0, 15, 250));
//? MIN
console.log(Math.min(55, 10, 1, 100, 0, 15, 250));
//? PI
console.log(Math.PI);
//? Random Number
